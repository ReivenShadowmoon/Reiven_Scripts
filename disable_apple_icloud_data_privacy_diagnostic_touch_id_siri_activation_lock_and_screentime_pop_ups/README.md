As this has not been updated in a few years by rtrouton I've taken the time to update the `payload_free_package` and script to work with macOS Big Sur and Monterey.
